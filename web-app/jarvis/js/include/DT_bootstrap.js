...
$.extend( $.fn.dataTableExt.oPagination, {
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).children('ul').addClass('pagination');
			var els = $('a', nPaging);
...
$(document).ready(function() {
	...
	if ($('#dtable').length){
		...
		$('#dtable').dataTable({
			...
			// define table layout
			"sDom" : "<'dt-header'<'row'<'col-md-6'f><'col-md-6 hidden-phone'T>r>r>t<'dt-footer'<'row'<'col-md-6 visible-md visible-lg'i><'col-md-6'p>>",
			// add paging 
			"sPaginationType" : "bootstrap",
			"oLanguage" : {
			...
			"oTableTools": {
				"sSwfPath": "../jarvis/js/include/assets/DT/swf/copy_csv_xls_pdf.swf",
				"aButtons": [
					// print layout
					{
						"sExtends": "print",
	...
	if ($('#col-filter').length){
		...
		oTable = $('#col-filter').dataTable({
			"sDom" : "t<'dt-footer'<'row'<'col-md-6 visible-md visible-lg'i><'col-md-6'p>>",
			"oLanguage" : {
