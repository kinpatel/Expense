	...
	function setup_flots() {
		...
		if ($("#revenue-chart").length) {
			...
			var options = {
					...
					tooltip : true,
					tooltipOpts : {
						content : "Your revenue for <b>%x</b> was <span>$%y</span>",
						dateFormat : "%y-%0m-%0d",
						defaultTheme : false
					},
					colors : [$chrt_second],
		...
		if ($("#expense-chart").length) {
			...
			var options = {
					...
					tooltip : true,
					tooltipOpts : {
						content : "Your expense for <b>%x</b> was <span>$%y</span>",
						dateFormat : "%y-%0m-%0d",
						defaultTheme : false
					},
					colors : [$chrt_second],
		...
		if ($("#expenserevenue-chart").length) {
			
			var d1 = chartExpenseMonthData
			var d2 = chartRevenueMonthData
			...
			$.plot($("#expenserevenue-chart"), ds, {
				...
				tooltip : true,
				tooltipOpts : {
					content : "<b>Month:%x</b> = <span>Value:%y</span>",
					defaultTheme : false
				}
