...
auditLog {
	...
	tablename = 'audit' // table name for audit logs.
...
grails.mail.default.from="hero@universeplace.com"

//Reverse engineering for existing tables
grails.plugin.reveng.includeTables = ['audit']
grails.plugin.reveng.packageName = 'com.hero'
grails.plugin.reveng.overwriteExisting = false
...
environments {
    ...
    production {
		...
		grails.serverURL = "http://hero.elasticbeanstalk.com"
