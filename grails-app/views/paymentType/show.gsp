						...
						<div class="jarviswidget" id="widget-id-0">
							...
							<div>
						        ...
						        <!-- content goes here -->
									...
									<fieldset>
										<g:if test="${paymentTypeInstance?.name}">
											<div class="form-group">											
												<div class="row">														
													<div  class="col-md-3">
														<span id="name-label" class="property-label"><g:message code="paymentType.name.label" default="Name:" /></span>												
													</div>
													<div class="col-md-9">
														<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${paymentTypeInstance}" field="name"/></span>
													</div>														
												</div>											
											</div>
										</g:if>
										
										<g:if test="${paymentTypeInstance?.description}">
											<div class="form-group">											
												<div class="row">														
													<div  class="col-md-3">
														<span id="name-label" class="property-label"><g:message code="paymentType.description.label" default="Description:" /></span>												
													</div>
													<div class="col-md-9">
														<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${paymentTypeInstance}" field="description"/></span>
													</div>														
												</div>											
											</div>
										</g:if>
										
										<g:form url="[resource:paymentTypeInstance, action:'delete']" method="DELETE">										
											<div class="form-actions">											
												...
												<span class="label">
													<g:link class="edit" action="edit" resource="${paymentTypeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
												</span>											
											</div>
										</g:form>
									</fieldset>
