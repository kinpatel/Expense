						        ...
						        <!-- content goes here -->
									...
									<g:hasErrors bean="${revenueDetailInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${revenueDetailInstance}" var="error">
											<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
											</g:eachError>
										</ul>
									</g:hasErrors>
									<g:form url="[resource:revenueDetailInstance, action:'update']" method="PUT" >
										<g:hiddenField name="version" value="${revenueDetailInstance?.version}" />
