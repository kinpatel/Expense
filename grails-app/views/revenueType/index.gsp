							...
							<div>
								...
								<div class="inner-spacer">		
									...
									<table class="table table-striped table-bordered responsive" id="dtable">
										<thead>
											<tr>
												<th> ${message(code: 'revenuetype.name.label', default: 'Name')} </th>
												<th> ${message(code: 'revenuetype.description', default: 'Description')} </th>
										...
										<tbody>
											<g:each in="${revenueTypeInstanceList}" status="i" var="revenueTypeInstance">
												<tr class="${(i % 2) == 0 ? 'gradeA' : 'gradeA'}">
													<td><g:link action="show" id="${revenueTypeInstance.id}">${fieldValue(bean: revenueTypeInstance, field: "name")}</g:link></td>
													<td>${fieldValue(bean: revenueTypeInstance, field: "description")}</td>
													<td>${fieldValue(bean: revenueTypeInstance, field: "hotel")}</td>	
													<td><g:link class="edit" action="edit" resource="${revenueTypeInstance}"><i class="icon-edit"></i> </g:link></td>
												</tr>
											</g:each>									
										</tbody>
