						...
						<div class="jarviswidget" id="widget-id-0">
						    ...
						    <div>
						        ...
						        <!-- content goes here -->
									...
									<g:hasErrors bean="${dailyRevenueInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${dailyRevenueInstance}" var="error">
											<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
											</g:eachError>
										</ul>
									</g:hasErrors>
									<g:form url="[resource:dailyRevenueInstance, action:'updateDailyRevenue']" method="PUT" >
										<g:hiddenField name="version" value="${dailyRevenueInstance?.version}" />
