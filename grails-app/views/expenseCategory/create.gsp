					...
					<article class="col-md-12">
						<div class="jarviswidget" id="widget-id-0">
							...
							<div>
						        ...
						        <!-- content goes here -->
						        	<g:hasErrors bean="${expenseCategoryInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${expenseCategoryInstance}" var="error">
											<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
											</g:eachError>
										</ul>
									</g:hasErrors>
									<g:form url="[resource:expenseCategoryInstance, action:'save']" class="form-horizontal themed">
