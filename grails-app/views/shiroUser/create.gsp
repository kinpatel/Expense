				...
				<div class="row">
					<article class="col-md-12">
						<div class="jarviswidget" id="widget-id-0">
							<header>
						        <h2><g:message code="shirouser.create.label" default="Create User"  /></h2>
						    </header>
						    <!-- wrap div -->
							<div>
						        ...
						        <!-- content goes here -->
									...
									<g:form url="[resource:shiroUserInstance, action:'save']" enctype="multipart/form-data">
										<fieldset class="form-horizontal themed" id="masked-inputs-js">
											...
											<div class="form-group">
												<div class="fieldcontain ${hasErrors(bean: shiroUserInstance, field: 'permissions', 'error')} required">
													<div class="row">
														<div  class="col-md-3">
															<label class="control-label" for="permissions"><g:message code="shiroUser.permissions.label" default="Permissions:" /><span class="req">*</span></label>
														</div>
														<div class="col-md-9">			
